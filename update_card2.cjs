...
const oldCardStart = content.indexOf("<div key={ticket.id} className=\"col-span-1 rounded-2xl p-5 flex flex-col justify-between bg-gradient-to-b from-[#18181A] to-[#111111] border border-white/5 shadow-xl relative group\">");
const oldCardEnd = content.indexOf("</button>\n              </div>", oldCardStart) + 30;

const oldCard = content.substring(oldCardStart, oldCardEnd);
