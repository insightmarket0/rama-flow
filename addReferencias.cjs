...
const targetStr = `                   <span className="text-white font-bold">O influencer divulga, o cliente compra. A RAMA entrega os produtos Curva A no mesmo dia (Prazo de 1 dia) em todo o ABC.</span>
                   </p>
                 </div>
...
const newStr = `                   <span className="text-white font-bold">O influencer divulga, o cliente compra. A RAMA entrega os produtos Curva A no mesmo dia (Prazo de 1 dia) em todo o ABC.</span>
                   </p>
                 </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="bg-white/5 p-4 border-l-4 border-[#CCFF00] hover:bg-white/10 transition-colors">
                        ...
                        <span className="text-white/60 text-[11px] uppercase font-bold tracking-wider mt-1 block">Ecosistemas de Alto Crescimento</span>
                      </div>
                    </div>
                  </div>
