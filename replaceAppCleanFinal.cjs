...
// Let's use the explicit closing string for the App Tab
const endStr = '          {activeTab === "ecossistema" && (';
const startIndex = content.lastIndexOf(startStr); // Use lastIndexOf to get the actual tab content, not a glow effect
...
\n`;
    ...
    console.log('Indexes missed: ' + startIndex + ' ' + endIndex);
}
