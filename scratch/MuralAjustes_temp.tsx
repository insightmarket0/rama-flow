...
export default function MuralAjustes() {
  ...
  const handleResolve = (id: string) => {
    ...
    setTickets(tickets.map(t => t.id === id ? { ...t, status: 'resolvido', resolved_by: 'VocÃª' } : t));
  };
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex items-center gap-2">
                      <div className={`h-2 w-2 rounded-full shrink-0 ${ticket.priority === 'critico' ? 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.8)] animate-pulse' : 'bg-[#00FF00] shadow-[0_0_8px_rgba(0,255,0,0.6)]'}`} title={ticket.priority === 'critico' ? 'CrÃ­tico / Risco' : 'Normal / EstÃ©tico'} />
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex items-center gap-2 shrink-0">
                  {ticket.assignee_name ? (
                    ...
                    <span className="text-xs text-gray-600 font-medium italic">NÃ£o atribuÃ­do</span>
                  )}
                </div>
            ...
            <div className="space-y-6 relative before:absolute before:inset-y-0 before:left-1.5 before:w-[1px] before:bg-white/5">
              ...
              <div className="relative pl-6">
                ...
                <p className="text-[11px] text-gray-400 leading-snug mb-1">
                  <span className="text-white font-bold">Lucas</span> resolveu ajuste de anÃºncio
                </p>
                ...
                <div className="flex items-center gap-1 text-gray-600">
                  ...
                  <span className="text-[8px] font-bold uppercase">HÃ¡ 5 min</span>
                </div>
              </div>
              ...
              <div className="relative pl-6">
                <div className="absolute left-[3px] top-1.5 w-2 h-2 rounded-full bg-[#00FF00] shadow-[0_0_8px_rgba(0,255,0,0.8)]" />
                <p className="text-[11px] text-gray-400 leading-snug mb-1">
                  <span className="text-white font-bold">JoÃ£o</span> deu Ciente em aviso crÃ­tico
                </p>
                <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider block mb-1.5 bg-white/5 w-fit px-2 py-0.5 rounded">
                  Mural Alinhamento
                </span>
                <div className="flex items-center gap-1 text-gray-600">
                  <Clock className="h-2.5 w-2.5" />
                  <span className="text-[8px] font-bold uppercase">HÃ¡ 12 min</span>
                </div>
              </div>
              ...
              <div className="relative pl-6">
                <div className="absolute left-[3px] top-1.5 w-2 h-2 rounded-full bg-[#00FF00] shadow-[0_0_8px_rgba(0,255,0,0.8)]" />
                <p className="text-[11px] text-gray-400 leading-snug mb-1">
                  <span className="text-white font-bold">Lucas</span> concluiu urgÃªncia
                </p>
                <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider block mb-1.5 bg-white/5 w-fit px-2 py-0.5 rounded">
                  Atualizar foto
                </span>
                <div className="flex items-center gap-1 text-gray-600">
                  <Clock className="h-2.5 w-2.5" />
                  <span className="text-[8px] font-bold uppercase">HÃ¡ 45 min</span>
                </div>
              </div>
              ...
              <div className="relative pl-6">
                ...
                <div className="flex items-center gap-1 text-gray-600">
                  <Clock className="h-2.5 w-2.5" />
                  <span className="text-[8px] font-bold uppercase">HÃ¡ 2 horas</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-[#111111] border-white/10 text-white max-w-md">
          ...
          <form onSubmit={handleCreateTicket} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-gray-500">ResponsÃ¡vel</label>
              <Select 
              ...
              >
                ...
                <SelectContent className="bg-[#111111] border-white/10 text-white">
                  ...
                  <SelectItem value="RogÃ©rio" className="hover:bg-white/10 focus:bg-white/10 focus:text-white cursor-pointer">
                    <div className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-[#111111] border-white/10 text-white">
                  <SelectItem value="normal" className="hover:bg-white/10 focus:bg-white/10 focus:text-white cursor-pointer">Normal / EstÃ©tico</SelectItem>
                  <SelectItem value="critico" className="hover:bg-white/10 focus:bg-white/10 focus:text-white cursor-pointer">CrÃ­tico / Risco de Bloqueio</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                placeholder="Descreva o ajuste necessÃ¡rio de forma clara..."
