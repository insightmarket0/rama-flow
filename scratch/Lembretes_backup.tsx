...
const MOCK_IDEAS = [
  {
    id: "1",
    content: "Talvez criar um playbook especÃ­fico sobre como tratar devoluÃ§Ãµes de eletrÃ´nicos no Mercado Livre. Temos tido muitas dÃºvidas nisso.",
    date: "Hoje Ã s 10:45",
    color: "bg-blue-500",
  },
  {
    id: "2",
    content: "Revisar as descriÃ§Ãµes da linha de Cozinha. O CTR caiu um pouco, podemos colocar os bullet points no topo.",
    date: "Ontem Ã s 16:30",
    color: "bg-[#00FF00]",
  },
  {
    id: "3",
    content: "Lembrar de pedir para o marketing as fotos de life-style dos produtos novos.",
    date: "19/07 Ã s 09:12",
    color: "bg-purple-500",
  }
];
...
const MOCK_CHECKLIST = [
  ...
  { id: "c2", title: "Revisar anÃºncios pausados", done: false },
  { id: "c3", title: "Aprovar orÃ§amentos de embalagem", done: false },
  { id: "c4", title: "Ler os 2 Playbooks novos", done: false },
];

const MOCK_AGENDA = [
  { id: "a1", title: "ReuniÃ£o de Alinhamento", day: "HOJE", time: "14:00 - Google Meet", isPriority: true },
  { id: "a2", title: "Fechamento de Ponto", day: "AMANHÃƒ", time: "AtÃ© as 18:00", isPriority: false },
  { id: "a3", title: "RenovaÃ§Ã£o de Contratos", day: "25/07", time: "09:00 - Financeiro", isPriority: false }
];
      ...
      <div className="mb-8 border-b border-white/5 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-6 shrink-0">
        <div>
          ...
          <p className="text-gray-500 mt-2 text-sm max-w-xl leading-relaxed">
            Um espaÃ§o totalmente seu. Organize sua agenda, checklist do dia a dia e rascunhos mentais longe do barulho da operaÃ§Ã£o.
          </p>
        </div>

        {/* MÃ³dulo de Captura RÃ¡pida no Topo (Stealth Input) */}
          ...
          <form onSubmit={handleAddThought} className="relative group">
            <div className="relative flex items-center bg-[#0A0A0A] border border-white/5 group-focus-within:border-[#00FF00]/40 rounded-xl overflow-hidden transition-all shadow-lg group-focus-within:shadow-[0_0_20px_rgba(0,255,0,0.05)]">
              ...
              <input 
                ...
                placeholder="O que estÃ¡ na sua mente agora?"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 min-h-0 overflow-y-auto pr-2 pb-20 custom-scrollbar">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#111111] border border-[#00FF00]/20 rounded-3xl p-6 shadow-[0_0_30px_rgba(0,255,0,0.02)] relative overflow-hidden">
            <div className="space-y-1">
              {agenda.length === 0 && (
                <p className="text-gray-600 text-xs font-bold uppercase tracking-widest text-center py-4">Sua agenda estÃ¡ livre!</p>
              )}
        ...
        <div className="space-y-6">
          ...
          {showChecklistForm && (
            <form onSubmit={handleAddChecklist} className="bg-[#111111] border border-[#00FF00]/20 rounded-2xl p-4 shadow-xl animate-in slide-in-from-top-2">
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="Ex: Enviar relatÃ³rio"
          ...
          <div className="bg-[#111111] border border-[#00FF00]/20 rounded-3xl p-6 shadow-[0_0_30px_rgba(0,255,0,0.02)] relative overflow-hidden">
            <div className="space-y-1">
              {checklist.length === 0 && (
                <p className="text-gray-600 text-xs font-bold uppercase tracking-widest text-center py-4">Sua lista estÃ¡ limpa!</p>
              )}
              {checklist.map(task => (
                <div 
                  key={task.id}
            ...
            {checklist.length > 0 && checklist.every(t => t.done) && (
              <div className="mt-4 flex items-center justify-center gap-2">
                <span className="text-[9px] font-bold text-[#00FF00]/50 uppercase tracking-widest">VocÃª concluiu tudo</span>
