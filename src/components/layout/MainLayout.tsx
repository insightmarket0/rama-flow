    ...
    <>
      ...
      <div className={`flex min-h-screen w-full ${location.pathname.startsWith('/marketing') ? '' : 'bg-background pl-24'}`}>
        ...
        <div className="flex flex-1 flex-col">
          <main className={`flex flex-col flex-1 ${(location.pathname.startsWith('/marketing') || location.pathname === '/brand-book' || location.pathname === '/equipe' || location.pathname === '/expedicao' || location.pathname === '/instaladores' || location.pathname === '/mural-ajustes') ? 'h-screen max-h-screen overflow-hidden' : 'p-6'}`}>
            <div key={location.pathname} className={`flex flex-col ${(location.pathname.startsWith('/marketing') || location.pathname === '/brand-book' || location.pathname === '/equipe' || location.pathname === '/expedicao' || location.pathname === '/instaladores' || location.pathname === '/mural-ajustes') ? 'flex-1 min-h-0 overflow-hidden' : 'space-y-6'} animate-in fade-in slide-in-from-bottom-4 zoom-in-95 duration-300 ease-out`}>
